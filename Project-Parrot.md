...
| Checkbox Group     | A special column type which represents and labels a grouping of checkboxes. **Every checkbox** must have an associated checkbox group. If you are looking to collect multi-select-like data, please create a checkbox group and configure checkboxes for each option.  |
